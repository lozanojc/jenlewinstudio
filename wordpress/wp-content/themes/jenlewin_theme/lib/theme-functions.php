...
function mb_scripts() {
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/js/vendor/jquery-2.1.1.js', array('jquery'), NULL, true );
		wp_enqueue_script( 'velocity', get_template_directory_uri() . '/assets/js/vendor/velocity.js', array('jquery'), NULL, true );
		wp_enqueue_script( 'velocityui', get_template_directory_uri() . '/assets/js/vendor/velocityui.js', array('jquery'), NULL, true );
