...
function _mbbasetheme_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<div class="project-navigation">
			<?php
				next_post_link(     '<div class="nav-next transition">%link</div>',     _x( '%title&nbsp;<span class="meta-nav">&rarr;</span>', 'Next post link',     '_mbbasetheme' ) );
				previous_post_link( '<div class="nav-previous" transition>%link</div>', _x( '<span class="meta-nav">&larr;</span>&nbsp;%title', 'Previous post link', '_mbbasetheme' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
