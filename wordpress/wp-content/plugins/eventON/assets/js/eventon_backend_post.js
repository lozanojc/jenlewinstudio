jQuery(document).ready(function($){
	...
	$('#color_selector').ColorPicker({		
		...
		function get_default_set_color(){
			var colorraw =$('#color_selector').css("border-left-color");
	...
	$('.evcal_color_box').click(function(){		
		...
		$('#color_selector').css({'border-color':new_hex_var});
	...
	$('#meta_tb').on( 'click','.evcal_yn_btn',function(){
		// yes
		if($(this).hasClass('btn_at_no')){
